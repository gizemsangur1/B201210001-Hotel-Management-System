            ...
            <table class="table  table-striped">
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td><a href="deleteroom.php?delete=<?=$row['room_id']?>" onclick="return confirm('Silinsin mi?')" class="btn btn-danger">Kaldır</a></td>
                                      <td><a href="updateroom.php?update=<?=$row['room_id']?>" onclick="return confirm('Güncellesin mi?')" class="btn btn-danger">Güncelle</a></td>
                                  </tr>
                              <?php
                              $i++;
                              }
