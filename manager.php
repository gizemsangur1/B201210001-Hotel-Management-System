...
<li title="Room"><a href="#" class="room-button fa-bed">bed</a></li>
...
<ul class="room-menu-bar">
  <li><a href="#" class="room-button">Menu</a></li>
...
<ul class="client-menu-bar">
  ...
  <li><a href="roombills.php">Room Bills</a></li>
  <li><a href="oldroombill.php">Old Room Bills</a></li>
</ul>
