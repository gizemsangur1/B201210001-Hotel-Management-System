<?php
 ...
 if(isset($_POST["btnSave"])&&$_POST["btnSave"]=="Save")
 {
     ...
     $nid=$_GET['update'];
     $su_name=$_POST["name"];
     $su_surname=$_POST["surname"];
     $su_salary=$_POST["salary"];
     $su_nationalid=$_POST["nid"];
     $su_category_work=$_POST["category"];
     $query="call update_staff('".$su_name."','".$su_surname."',".$su_salary.",".$su_nationalid.",'".$su_category_work."')";
